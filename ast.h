...
struct AstNode {
    ...
    union {
        ...
        struct { AstList params; AstList defaults; AstNode *body;
                 const char *src; uint32_t srclen; } lambda;   /* defaults: per-param,
                 NULL items for none (entry 13); trailing-only, parser-enforced */
